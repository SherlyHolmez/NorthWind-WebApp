    ...
    public class CustomerDAL
    {
        ...
        public Customer LastCustomer()
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    LastCustomer.CustomerId = reader.GetString(reader.GetOrdinal("CustomerID"));
                    LastCustomer.CompanyName = reader.GetString(reader.GetOrdinal("CompanyName"));
                    LastCustomer.CustomerName = reader.GetString(reader.GetOrdinal("ContactName"));
                    LastCustomer.CustomerTitle = reader.GetString(reader.GetOrdinal("ContactTitle"));
                    LastCustomer.Address = reader.GetString(reader.GetOrdinal("Address"));
                }
                connection.Close();
                reader.Close();
            }
